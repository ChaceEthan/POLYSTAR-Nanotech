...
const rawEnv = {
  ...
  CLIENT_URL: process.env.CLIENT_URL ?? process.env.CORS_ORIGIN ?? process.env.FRONTEND_URL ?? process.env.APP_URL,
  CORS_ORIGIN: process.env.CORS_ORIGIN ?? process.env.CLIENT_URL ?? process.env.FRONTEND_URL ?? process.env.APP_URL,
  FRONTEND_URL: process.env.FRONTEND_URL ?? process.env.CORS_ORIGIN ?? process.env.CLIENT_URL ?? process.env.APP_URL,
