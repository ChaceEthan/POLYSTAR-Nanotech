...
export const requestController = {
  contact: async (req: Request, res: Response) => {
    ...
    return created(res, contact, "Contact request received");
  },
  quotation: async (req: Request, res: Response) => {
    ...
    return created(res, quotation, "Quotation request received");
  },
  consultation: async (req: Request, res: Response) => {
    ...
    return created(res, consultation, "Consultation request received");
  },
  siteVisit: async (req: Request, res: Response) => {
    ...
    return created(res, siteVisit, "Site visit request received");
  }
};
