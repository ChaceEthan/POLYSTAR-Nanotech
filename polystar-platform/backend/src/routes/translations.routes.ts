...
translationsRoutes.use(authenticate, authorize("super_admin", "admin", "editor", "translations:read"));
translationsRoutes.get("/", translationsController.list);
translationsRoutes.post("/", authorize("super_admin", "admin", "editor", "translations:write"), validate({ body: translationBodySchema }), translationsController.upsert);
translationsRoutes.delete(
  "/:locale/:namespace/:key",
  authorize("super_admin", "admin", "translations:delete"),
